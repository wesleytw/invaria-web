  ...
  return (
    <div>
      ...
      <div className=" min-w-full max-w-full relative overscroll-none overflow-hidden h-full bg-gradient-to-b from-[#44334C] to-[#1E1722]
         text-white">
        <div className=" px-4 md:px-16 lg:px-[231px] md:pt-[80px]">
          <div className=' mt-[45px] font-semibold text-2xl'>Dashboard</div>
          <div className=' relative mt-[29px] h-[36px] w-[50px] border-b-2 text-base font-semibold'>
            Profile
          </div>
        </div>
        <div className="px-4 md:px-16 lg:px-[231px] pt-[36px] border-t border-invar-main-purple flex">
          <div className="mb-[38px] w-[214px] min-w-[214px] h-[214px] flex flex-col justify-start items-center rounded">
